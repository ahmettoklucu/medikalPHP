            ...
            <div class="col-md-4">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="advert_name">İlan Adı:</label>
                        <input type="text" required value="<?= post('advert_name')?>" class="form-control" name="advert_name" id="advert_name">
                    </div>
                    <div class="form-group">
                        <label for="advert_address">İlan adres</label>
                        <textarea type="text"  rows="8" cols="80" required class="form-control" name="advert_description" id="advert_description">
                            <?= post('advert_description')?>
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label for="product_deacription">İlan Açıklama</label>
                        <textarea type="text"  rows="8" cols="80" required class="form-control" name="advert_address" id="advert_address">
                            <?= post('advert_address')?>
                        </textarea>
                    </div>
                    <div class="form-group">
                        <label for="advert_image">Anaresim</label>
                        <input type="File" required value="<?=post('advert_image')?>"class="form-control" name="advert_image" id="advert_image">
                    </div>
                    <div class="form-group">
                        <label for="advert_image1">1.Resim</label>
                        <input type="File" value="<?=post('advert_image1')?>"class="form-control" name="advert_image1" id="advert_image1">
                    </div>
                    <div class="form-group">
                        <label for="advert_image2">2.Resim</label>
                        <input type="File" value="<?=post('advert_image2')?>"class="form-control" name="advert_image2" id="advert_image2">
                    </div>
                    <div class="form-group">
                        <label for="advert_image3">3.Resim</label>
                        <input type="File" value="<?=post('advert_image3')?>"class="form-control" name="advert_image3" id="advert_image3">
                    </div>
                    <div class="form-group">
                        <label for="advert_image4">4.Resim</label>
