            ...
            <div class="col-md-4">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required value="<?= post('product_name')?>" class="form-control" name="product_name" id="product_name">
                    </div>
                    <div class="form-group">
                        <label for="product_deacription">Cihaz Açıklama</label>
                        <textarea type="text"  rows="8" cols="80" required value="<?=post('product_description')?>" class="form-control" name="product_deacription" id="product_deacription"></textarea>
                    </div>
                    <div class="form-group">
